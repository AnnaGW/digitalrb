...
export function Location2Ico({ width, height }: IconProps) {
	return (
		<svg
			version="1.1"
			id="Capa_1"
		...
		>
			<path
				fill="currentColor"
				d="M39.652,16.446C39.652,7.363,32.289,0,23.206,0C14.124,0,6.761,7.363,6.761,16.446c0,1.775,0.285,3.484,0.806,5.086h0
