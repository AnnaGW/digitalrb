...
export function SurveillanceIco({ width, height }: IconProps) {
	return (
		<svg
			version="1.1"
			...
			width={width}
			height={height}
			viewBox="0 0 332.396 332.396"
		>
			<title>Видеонаблюдение</title>
			<g>
				<path
					fill="currentColor"
					d="M317.055,32.986H15.334C6.883,32.986,0,39.862,0,48.32v186.494c0,8.458,6.877,15.354,15.334,15.354h114.333v34.981H96.107
